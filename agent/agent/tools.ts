...
export const searchBoxFiles = tool(
...
export const listBoxFiles = tool(
  async () => {
...
export const extractBoxFields = tool(
  async ({
    fileId,
    fields,
  }: {
...
export const createBoxFolder = tool(
...
export const writeSummaryToBox = tool(
  async ({
    filename,
    markdown,
    folder,
